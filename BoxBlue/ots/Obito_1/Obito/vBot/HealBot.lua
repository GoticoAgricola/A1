...
if rootWidget then
  ...
  healWindow.spells.addSpell.onClick = function(widget)
    ...
    if spellSource == "Chakra atual" then
      source = "CP"
    elseif spellSource == "Vida Atual" then
      source = "HP"
    elseif spellSource == "Chakra Percent" then
      source = "CP%"
    ...
    if spellEquasion == "Acima" then
      equasion = ">"
    elseif spellEquasion == "Abaixo" then
      equasion = "<"
    else
      equasion = "="
    end
  ...
  healWindow.items.addItem.onClick = function(widget)
    ...
    if src == "Chakra Atual" then
      source = "CP"
    elseif src == "Vida Atual" then
      source = "HP"
    elseif src == "chakra Percent" then
      source = "CP%"
...
UI.TextEdit(storage.antiParalyze or "kai", function(widget, newText)
  storage.antiParalyze = newText
end)

macro(100, "ativar anti paralyze", function() 
